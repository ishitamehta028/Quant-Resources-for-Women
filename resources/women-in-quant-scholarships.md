# Scholarships, Fellowships & Communities for Women in Quantitative Finance

A curated, contribution-friendly list of funding and community resources specifically supporting women breaking into or advancing in quant finance. Entries marked **[verify link]** are real, named programs where the official deep-link needs a contributor to confirm and add it — see [`CONTRIBUTING.md`](../CONTRIBUTING.md) for how easy this is to fix.

Last major review of this file: 2026-06-21. Funding amounts and deadlines change — always confirm on the organization's own site before applying.

## Scholarships & PhD funding
...
## Mentorship & professional communities
...
| Program | What it offers | Official source |
|---|---|---|
